...
function changeType(): void {
  if (form.type === 'database') {
    if (form.port === 22 || form.port === 115200 || form.port > 65535) form.port = form.databaseType === 'mysql' ? 3306 : form.databaseType === 'postgres' ? 5432 : 1
